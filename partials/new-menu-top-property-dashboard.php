	...
	<div class="text-right"><span class="close-lg">&times;</span></div>
		<ul class="items clearfix">
			<li> <a href="#" class="item" title="Show Activity"><i class="fa fa-area-chart"></i> Live Feed</a> </li>
			<li> <a href="#" class="item active" title="Rent"> <i class="fa fa-usd"> </i> Rent</a> </li>
