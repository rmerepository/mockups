...
<div class="collapsible-forms">
	<div class="medium-items">
      ...
      <div class="row">
          <div class="col-md-4">
            <div class="control-group">
              <label class="control-label" for="firstRentPayment">First Rent Payment (Deposit) <a href="http://support.rentmyestate.com.au/article/72-first-rent-payment-deposit" target="_blank"></a> </label>
              <div class="controls">
