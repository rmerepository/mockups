...
<div class="row me-well"> 
			...
			<div class="pull-right">
	                ...
	                <div class="controls clearfix">
										<figure class="dd-w-button">
		                	<button onclick="alert('Manage Ad')" class="btn btn-primary btn-main-action"  id="mainAction">
		                		Manage Ad
		                	</button>
			...
			<div class="row me-well"> 
			<div class="pull-left">
				 <span class="me-lbl">Enquiries</span>
			</div>			
			<div class="pull-right">		
				<a href="#" class="btn btn-primary form-fixed-width">1 New Enquiry</a>
			</div>
			</div>
			<div class="row me-well"> 
			<div class="pull-left">
				 <span class="me-lbl">Tenant</span>
			</div>			
			<div class="pull-right">		
				<a href="#" class="btn btn-primary form-fixed-width">Add New Tenancy</a>
			</div>
			</div>
			<div class="row me-well"> 
			<div class="pull-left">
				 <span class="me-lbl">Applications</span>
			</div>			
			<div class="pull-right">		
				<a href="#" class="btn btn-primary form-fixed-width">View Applications</a>
			</div>
			</div>
			<div class="row me-well"> 
			<div class="pull-left">
			...
			<div class="pull-right">
	                ...
	                <div class="controls clearfix">
	                <figure class="dd-w-button">
		                	<button onclick="alert('Send a Message')" class="btn btn-primary btn-main-action"  id="mainAction">
		                		Send a Message
		                	</button>
