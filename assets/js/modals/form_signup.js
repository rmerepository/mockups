...
function rme_form_validate_signup(element_id,config,fn){	
...
/*
	jQuery('#'+ element_id).on('submit', function(e)
	{
...
function validateAgreeTermsCondition()
	{
		...
		if(terms === false) 
		{
		  ...
		  jQuery('.termsandcondition').append('<div for="termsandcondition" generated="true" class="msg">Oops, you forgot to agree with our Terms & Conditions.</div>');
			valid = false;
		} 
		else
		{
...
function rme_show_modal_register(e){
